        ...
        return this.each(function (index) {
            ...
            function uploadSubmitHandler() {
                if (state.fileBatch.length < 2) {
                    ...
                    $("#hansup").html('<img src="https://cdn.jsdelivr.net/gh/acodegod/pic-cdn@585074dd7280c28f17cd83bd7ccebe697b3e9a6b/2021/03/16/b7fade575e3e237232ea5276531f815c.png">');
                    $.ajax({
                        type: 'POST',
                        url: options.ajaxUrl,
                        data: data,
